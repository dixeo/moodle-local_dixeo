...
class provider implements
    ...
    public static function delete_data_for_all_users_in_context(\context $context): void {
        ...
        $DB->delete_records(self::TABLE_IMAGE_JOB, ['courseid' => $courseid]);
    ...
    public static function delete_data_for_user(approved_contextlist $contextlist): void {
        ...
        [$insql5, $params5] = $DB->get_in_or_equal($courseids, SQL_PARAMS_NAMED);
        $params5['userid'] = $userid;
        $DB->delete_records_select(
            self::TABLE_IMAGE_JOB,
            "userid = :userid AND courseid {$insql5}",
            $params5
        );
    ...
    public static function delete_data_for_users(approved_userlist $userlist): void {
        ...
        [$insql5, $params5] = $DB->get_in_or_equal($userids, SQL_PARAMS_NAMED);
        $params5['courseid'] = $courseid;
        $DB->delete_records_select(
            self::TABLE_IMAGE_JOB,
            "courseid = :courseid AND userid {$insql5}",
            $params5
        );
