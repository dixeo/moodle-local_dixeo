...
$string['tutor_usage_report_kpi_duration'] = 'Sitzungsdauer';
$string['tutor_usage_report_kpi_duration_info'] = 'Gesamtzeit in Tutor-Sitzungen. Jede Sitzung zählt die Zeit zwischen ihrer ersten und letzten Nachricht plus {$a}.';
...
$string['tutor_usage_report_kpi_engagement_info'] = 'Durchschnittliche Anzahl unterschiedlicher Tage, an denen jeder aktive Nutzer den Tutor im Zeitraum genutzt hat.';
...
$string['tutor_usage_report_kpi_messages_info'] = 'Anzahl der im Zeitraum an den Tutor gesendeten Nachrichten.';
