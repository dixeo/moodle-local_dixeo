...
$string['tutor_usage_report_kpi_duration'] = 'Durée de session';
$string['tutor_usage_report_kpi_duration_info'] = 'Temps total passé en sessions avec le tuteur. Chaque session compte le temps entre son premier et son dernier message, plus {$a}.';
...
$string['tutor_usage_report_kpi_engagement_info'] = 'Nombre moyen de jours distincts où chaque utilisateur actif a utilisé le tuteur pendant la période.';
...
$string['tutor_usage_report_kpi_messages_info'] = 'Nombre de messages envoyés au tuteur pendant la période.';
