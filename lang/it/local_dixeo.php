...
$string['credit_report_filter_noselection'] = 'Nessuna selezione';
...
$string['credit_report_no_chart_data'] = 'Nessun dato grafico per il periodo selezionato.';
...
$string['tutor_usage_report_apply_filters'] = 'Applica filtri';
...
$string['tutor_usage_report_cell_tooltip_sessions'] = 'Durata media: {$a}';
...
$string['tutor_usage_report_filters'] = 'Filtri';
...
$string['tutor_usage_report_kpi_mode_secondary_lesson'] = 'Lezioni create: {$a}';
...
$string['tutor_usage_report_level_site'] = 'Sito';
...
$string['tutor_usage_report_reset_filters'] = 'Reimposta';
$string['tutor_usage_report_rolescope_all'] = 'Tutti gli utenti';
$string['tutor_usage_report_rolescope_students'] = 'Solo studenti';
$string['tutor_usage_report_rolescope_teachers'] = 'Solo docenti';
