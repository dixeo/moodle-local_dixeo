...
$string['cachedef_coursetemplates'] = 'Modelli di struttura del corso memorizzati nella cache dall\'API Dixeo';
$string['cachedef_installedplugintypes'] = 'Tipi di plugin attività installati memorizzati nella cache per la generazione Dixeo';
$string['cachedef_moduletypes'] = 'Tipi di modulo memorizzati nella cache dall\'API Dixeo';
$string['configure_api'] = 'Configura API';
$string['content_image_failed'] = 'Si è verificato un errore';
$string['content_image_generating'] = 'Generazione...';
$string['contentimagetitlefallback'] = 'Immagine di contenuto';
$string['credit_action_assign_authorship'] = 'Verifica autenticità compito';
$string['credit_action_assign_grade'] = 'Valutazione compito con IA';
$string['credit_action_assign_review'] = 'Revisione compito';
$string['credit_action_course_structure'] = 'Struttura del corso';
$string['credit_action_edit_module'] = 'Modifica modulo';
$string['credit_action_fill_module'] = 'Compila modulo';
$string['credit_action_generate_module'] = 'Genera modulo';
$string['credit_action_image_edit'] = 'Modifica immagine';
$string['credit_action_image_generate'] = 'Genera immagine';
$string['credit_action_module_edit'] = 'Modifica modulo';
$string['credit_action_module_fill'] = 'Compila modulo';
$string['credit_action_module_generate'] = 'Genera modulo';
$string['credit_action_tutor'] = 'Messaggio tutor';
$string['credit_action_tutor_message'] = 'Messaggio tutor';
$string['credit_action_unknown'] = 'Azione sconosciuta';
$string['credit_balance'] = 'Saldo crediti';
$string['credit_component_block_dixeo_designer'] = 'Progettista corsi';
$string['credit_component_block_dixeo_modulegen'] = 'Generatore moduli';
$string['credit_component_block_dixeo_tutor'] = 'Tutor studenti';
$string['credit_component_filter_dixeo_imageeditor'] = 'Editor immagini';
$string['credit_component_local_dixeo'] = 'Nucleo Dixeo';
$string['credit_component_local_dixeo_editor'] = 'Editor contenuti';
$string['credit_component_unknown'] = 'Sconosciuto';
$string['credit_context_site'] = 'Sito';
$string['credit_information'] = 'Informazioni sui crediti';
$string['credit_moduletype_assign'] = 'Compito';
$string['credit_moduletype_glossary'] = 'Glossario';
$string['credit_moduletype_h5pactivity'] = 'Attività H5P';
$string['credit_moduletype_label'] = 'Etichetta';
$string['credit_moduletype_page'] = 'Pagina';
$string['credit_moduletype_quiz'] = 'Quiz';
$string['credit_moduletype_simplequiz2'] = 'Quiz semplice';
$string['credit_moduletype_slideshow'] = 'Presentazione';
$string['credit_report'] = 'Report crediti';
$string['credit_report_apply_filters'] = 'Applica filtri';
$string['credit_report_breakdown'] = 'Crediti per modulo';
$string['credit_report_column_action'] = 'Azione';
$string['credit_report_column_course'] = 'Corso: Attività';
$string['credit_report_column_credits'] = 'Crediti';
$string['credit_report_column_date'] = 'Data';
$string['credit_report_column_module'] = 'Componente';
$string['credit_report_column_user'] = 'Utente';
$string['credit_report_filter_action'] = 'Azione';
$string['credit_report_filter_component'] = 'Componente';
$string['credit_report_filter_course'] = 'Corso';
$string['credit_report_filter_course_placeholder'] = 'Cerca corsi…';
$string['credit_report_filter_credits_max'] = 'Crediti max';
$string['credit_report_filter_credits_min'] = 'Crediti min';
$string['credit_report_filter_moduletype'] = 'Tipo attività';
$string['credit_report_filter_placeholder'] = 'Cerca o seleziona…';
$string['credit_report_filter_user'] = 'Utente';
$string['credit_report_filter_user_placeholder'] = 'Cerca utenti…';
$string['credit_report_filters'] = 'Filtri';
$string['credit_report_histogram'] = 'Crediti nel tempo';
$string['credit_report_kpi_courses'] = 'Totale corsi';
$string['credit_report_kpi_credits'] = 'Totale crediti';
$string['credit_report_kpi_rows'] = 'Totale transazioni';
$string['credit_report_kpi_users'] = 'Totale utenti';
$string['credit_report_link_desc'] = 'Richiede la capacità local/dixeo:manage o local/dixeo:viewusage a livello di sito. Il report e l\'export includono nomi di utenti e corsi su tutto il sito.';
$string['credit_report_next_period'] = 'Periodo successivo';
...
$string['credit_report_view_month'] = 'Mese';
$string['credit_report_view_week'] = 'Settimana';
$string['credit_usage_report_nav'] = 'Utilizzo crediti Dixeo';
$string['credit_user_unknown'] = 'Sconosciuto';
...
$string['dixeo:viewtutorusage'] = 'Visualizza report utilizzo tutor nei corsi';
$string['dixeo:viewtutorusagesite'] = 'Visualizza report utilizzo tutor a livello di sito';
$string['dixeo:viewusage'] = 'Visualizzare i report sull\'utilizzo dei crediti su tutto il sito ed esportare i dati';
...
$string['eventcreditreportvieweddesc'] = 'L\'utente con id \'{$a->userid}\' ha visualizzato il report utilizzo crediti (vista={$a->view}, righe={$a->rowcount}).';
$string['eventfilesyncdisabled'] = 'Sincronizzazione file Dixeo del corso disabilitata';
$string['eventfilesyncdisableddesc'] = 'L\'utente con id \'{$a->userid}\' ha disabilitato la sincronizzazione file Dixeo per il corso con id \'{$a->courseid}\' (removefiles={$a->removefiles}, remotedelete={$a->remotedeletestatus}).';
...
$string['eventtutorusagereportexported'] = 'Report utilizzo tutor esportato';
$string['eventtutorusagereportexporteddesc'] = 'L\'utente {$a->userid} ha esportato il report di utilizzo del tutor (livello: {$a->level}, vista: {$a->view}, formato: {$a->dataformat}, righe: {$a->rowcount}).';
$string['eventtutorusagereportviewed'] = 'Report utilizzo tutor visualizzato';
$string['eventtutorusagereportvieweddesc'] = 'L\'utente {$a->userid} ha visualizzato il report di utilizzo del tutor (livello: {$a->level}, vista: {$a->view}, righe: {$a->rowcount}).';
...
$string['filesync_status_pending_deletion'] = 'Eliminazione remota dei file in sospeso';
...
$string['image_generation_content_mode'] = 'Immagini di contenuto';
$string['image_generation_content_mode_desc'] = 'Controlla le azioni IA sulle immagini nel contenuto delle attività, come Pagine e Libri.';
...
$string['privacy:metadata:credit_usage'] = 'Record di utilizzo crediti Dixeo sincronizzati, arricchiti con il contesto Moodle.';
$string['privacy:metadata:credit_usage:amount'] = 'L\'importo firmato della transazione.';
$string['privacy:metadata:credit_usage:cmid'] = 'L\'ID del modulo del corso quando noto.';
$string['privacy:metadata:credit_usage:component'] = 'Il componente Dixeo di origine.';
$string['privacy:metadata:credit_usage:contextid'] = 'Il contesto Moodle quando noto.';
$string['privacy:metadata:credit_usage:courseid'] = 'Il corso quando noto.';
$string['privacy:metadata:credit_usage:credits'] = 'L\'importo normalizzato di utilizzo crediti.';
$string['privacy:metadata:credit_usage:description'] = 'La descrizione della transazione API.';
$string['privacy:metadata:credit_usage:jobid'] = 'L\'identificatore remoto del job Dixeo quando disponibile.';
$string['privacy:metadata:credit_usage:jobtype'] = 'Il tipo di job API quando disponibile.';
$string['privacy:metadata:credit_usage:moduletype'] = 'Il tipo di attività Moodle quando noto.';
$string['privacy:metadata:credit_usage:operation'] = 'Il fallback dell\'operazione locale.';
$string['privacy:metadata:credit_usage:timecreated'] = 'Il timestamp della transazione.';
$string['privacy:metadata:credit_usage:timesynced'] = 'Quando la riga è stata sincronizzata l\'ultima volta.';
$string['privacy:metadata:credit_usage:transactionid'] = 'L\'identificatore remoto della transazione Dixeo.';
$string['privacy:metadata:credit_usage:type'] = 'Il tipo di transazione.';
$string['privacy:metadata:credit_usage:userid'] = 'L\'utente che ha avviato l\'operazione quando noto.';
...
$string['privacy:metadata:jobs:accessmode'] = 'Se il lavoro è limitato all\'iniziatore o condiviso nel corso per il controllo degli accessi.';
$string['privacy:metadata:jobs:cmid'] = 'L\'ID del modulo del corso quando noto.';
$string['privacy:metadata:jobs:component'] = 'Il componente Dixeo di origine per il job.';
$string['privacy:metadata:jobs:contextid'] = 'Il contesto Moodle quando noto.';
...
$string['privacy:metadata:jobs:moduletype'] = 'Il tipo di attività Moodle quando noto.';
...
$string['privacy:metadata:tutor_usage_daily'] = 'Aggregati giornalieri di utilizzo del tutor';
$string['privacy:metadata:tutor_usage_daily:cmid'] = 'L\'id del modulo del corso';
$string['privacy:metadata:tutor_usage_daily:courseid'] = 'L\'id del corso';
$string['privacy:metadata:tutor_usage_daily:daystart'] = 'Il giorno coperto dall\'aggregato';
$string['privacy:metadata:tutor_usage_daily:lastactive'] = 'Timestamp dell\'ultima attività';
$string['privacy:metadata:tutor_usage_daily:lessoncreated'] = 'Lezioni Teach create';
$string['privacy:metadata:tutor_usage_daily:messages'] = 'Conteggio messaggi del giorno';
$string['privacy:metadata:tutor_usage_daily:mode'] = 'La modalità del tutor';
$string['privacy:metadata:tutor_usage_daily:quizcreated'] = 'Quiz di pratica creati';
$string['privacy:metadata:tutor_usage_daily:userid'] = 'L\'id dell\'utente';
$string['privacy:metadata:tutor_usage_event'] = 'Eventi di utilizzo del tutor';
$string['privacy:metadata:tutor_usage_event:cmid'] = 'L\'id del modulo del corso quando noto';
$string['privacy:metadata:tutor_usage_event:courseid'] = 'Il corso in cui si è verificato l\'evento';
$string['privacy:metadata:tutor_usage_event:eventtype'] = 'Il tipo di evento di utilizzo del tutor';
$string['privacy:metadata:tutor_usage_event:mode'] = 'La modalità di interazione del tutor';
$string['privacy:metadata:tutor_usage_event:timecreated'] = 'Quando l\'evento è stato registrato';
$string['privacy:metadata:tutor_usage_event:userid'] = 'L\'utente che ha attivato l\'evento del tutor';
$string['privacy:metadata:tutor_usage_open'] = 'Sessioni tutor aperte';
$string['privacy:metadata:tutor_usage_open:courseid'] = 'L\'id del corso';
$string['privacy:metadata:tutor_usage_open:lastmessage'] = 'Timestamp dell\'ultimo messaggio';
$string['privacy:metadata:tutor_usage_open:messagecount'] = 'Messaggi finora nella sessione';
$string['privacy:metadata:tutor_usage_open:timestart'] = 'Ora di inizio della sessione';
$string['privacy:metadata:tutor_usage_open:userid'] = 'L\'id dell\'utente';
$string['privacy:metadata:tutor_usage_session'] = 'Sessioni di utilizzo del tutor chiuse';
$string['privacy:metadata:tutor_usage_session:courseid'] = 'L\'id del corso';
$string['privacy:metadata:tutor_usage_session:duration'] = 'Durata della sessione in secondi';
$string['privacy:metadata:tutor_usage_session:messagecount'] = 'Messaggi nella sessione';
...
$string['privacy:path:tutor_usage'] = 'Analitiche di utilizzo del tutor';
...
$string['task_aggregate_tutor_usage'] = 'Aggrega le analitiche di utilizzo del tutor Dixeo';
...
$string['task_process_remote_file_deletion'] = 'Riprovare eliminazione remota file Dixeo';
...
5. SOLO TESTO: Produci solo testo. Non includere immagini, illustrazioni, tag <img> o segnaposto [img-gen ...]. Le lezioni personalizzate non elaborano i segnaposto delle immagini.

Prima di terminare, verifica che il campo content sia sostanzioso, solo testo, e risponda direttamente alla richiesta dello studente.';
$string['tutor_usage_duration_days'] = '{$a->days}g {$a->hours}h {$a->minutes}m';
...
$string['tutor_usage_report_breadcrumb'] = 'Navigazione del report';
$string['tutor_usage_report_cell_tooltip_adoption'] = '{$a->active} su {$a->total} utenti';
$string['tutor_usage_report_cell_tooltip_sessions'] = 'Durata media: {$a->average} · Totale: {$a->total}';
$string['tutor_usage_report_change_since_month'] = 'dal mese scorso';
$string['tutor_usage_report_change_since_week'] = 'dalla settimana scorsa';
$string['tutor_usage_report_column_guide'] = 'Guide';
$string['tutor_usage_report_column_lastactive'] = 'Ultima attività';
$string['tutor_usage_report_column_messages'] = 'Messaggi';
$string['tutor_usage_report_column_moduletype'] = 'Tipo di attività';
$string['tutor_usage_report_column_name'] = 'Nome';
$string['tutor_usage_report_column_quiz'] = 'Quiz';
$string['tutor_usage_report_column_sessions'] = 'Sessioni';
$string['tutor_usage_report_column_standard'] = 'Standard';
$string['tutor_usage_report_column_teach'] = 'Teach';
$string['tutor_usage_report_course_page'] = 'Pagina del corso';
$string['tutor_usage_report_filter_roles'] = 'Utenti';
$string['tutor_usage_report_heatmap'] = 'Mappa di calore dell\'attività';
$string['tutor_usage_report_heatmap_info'] = 'Numero totale di messaggi inviati in ogni fascia di tre ore, per giorno della settimana.';
$string['tutor_usage_report_kpi_adoption'] = 'Adozione';
$string['tutor_usage_report_kpi_adoption_info'] = 'Quota di utenti nell\'ambito che hanno usato il tutor almeno una volta nel periodo.';
$string['tutor_usage_report_kpi_adoption_secondary'] = '{$a->active} attivi / {$a->inactive} inattivi / {$a->total} totali';
$string['tutor_usage_report_kpi_duration'] = 'Durata';
$string['tutor_usage_report_kpi_duration_info'] = 'Tempo totale trascorso interagendo con il tutor durante il periodo.';
$string['tutor_usage_report_kpi_duration_secondary'] = 'Mediana {$a->median} / Media {$a->average}';
$string['tutor_usage_report_kpi_engagement'] = 'Coinvolgimento';
$string['tutor_usage_report_kpi_engagement_info'] = 'Il totale del numero di giorni in cui gli utenti hanno interagito con il tutor durante il periodo';
$string['tutor_usage_report_kpi_engagement_info_user'] = 'Numero di giorni distinti in cui questo utente ha usato il tutor nel periodo.';
$string['tutor_usage_report_kpi_engagement_secondary'] = 'Ultima attività: {$a}';
$string['tutor_usage_report_kpi_engagement_secondary_aggregate'] = 'Mediana {$a->median} / Media {$a->average} giorni attivi per utente attivo';
$string['tutor_usage_report_kpi_engagement_value'] = '{$a} giorni';
$string['tutor_usage_report_kpi_messages'] = 'Messaggi';
$string['tutor_usage_report_kpi_messages_info'] = 'Numero totale di messaggi inviati al tutor durante il periodo.';
$string['tutor_usage_report_kpi_messages_secondary'] = 'Mediana {$a->median} / Media {$a->average}';
$string['tutor_usage_report_kpi_mode_desc_lesson'] = 'lezioni create';
$string['tutor_usage_report_kpi_mode_desc_messages'] = 'messaggi inviati';
$string['tutor_usage_report_kpi_mode_desc_quiz'] = 'quiz inviati';
$string['tutor_usage_report_kpi_mode_info_guide'] = 'Messaggi inviati in modalità Guida, dove il tutor porta lo studente alla risposta invece di darla.';
$string['tutor_usage_report_kpi_mode_info_normal'] = 'Messaggi inviati in modalità Standard, dove il tutor risponde direttamente alle domande.';
$string['tutor_usage_report_kpi_mode_info_quiz'] = 'Messaggi inviati in modalità Quiz, i risultati del quiz sono inviati al tutor per l\'analisi.';
$string['tutor_usage_report_kpi_mode_info_teach'] = 'Messaggi inviati in modalità Insegna, le lezioni generate diventano parte della conversazione.';
$string['tutor_usage_report_kpi_mode_secondary_quiz'] = 'Quiz creati: {$a}';
$string['tutor_usage_report_kpi_sessions'] = 'Sessioni';
$string['tutor_usage_report_kpi_sessions_info'] = 'Numero di sessioni con il tutor. Una sessione inizia col primo messaggio e si chiude dopo {$a} senza nuovi messaggi.';
$string['tutor_usage_report_kpi_sessions_secondary'] = 'Mediana {$a->median} / Media {$a->average}';
$string['tutor_usage_report_level_site'] = 'Tutti i corsi';
$string['tutor_usage_report_nav'] = 'Utilizzo tutor Dixeo';
$string['tutor_usage_report_next_period'] = 'Periodo successivo';
$string['tutor_usage_report_no_rows'] = 'Nessun record di utilizzo del tutor trovato per il periodo e i filtri selezionati.';
$string['tutor_usage_report_performance'] = 'Prestazioni';
$string['tutor_usage_report_performance_activities'] = 'Attività valutate';
$string['tutor_usage_report_performance_axis_grade'] = 'Valutazione (%)';
$string['tutor_usage_report_performance_axis_usage'] = 'Messaggi (sempre)';
$string['tutor_usage_report_performance_column_average'] = 'Valutazione media';
$string['tutor_usage_report_performance_column_user_vs_average'] = 'Utente / media';
$string['tutor_usage_report_performance_course_total'] = 'Totale del corso';
$string['tutor_usage_report_performance_mean_grade'] = 'Valutazione media';
$string['tutor_usage_report_performance_mean_usage'] = 'Utilizzo medio';
$string['tutor_usage_report_performance_na'] = '—';
$string['tutor_usage_report_performance_scatter'] = 'Utilizzo vs valutazione';
$string['tutor_usage_report_performance_scatter_empty'] = 'Nessuno studente valutato da mostrare ancora.';
$string['tutor_usage_report_performance_user_vs_average'] = '{$a->user} / {$a->average}';
$string['tutor_usage_report_period'] = 'Periodo';
$string['tutor_usage_report_prev_period'] = 'Periodo precedente';
$string['tutor_usage_report_range_too_long'] = 'Gli intervalli di date personalizzati non possono superare i sei mesi.';
$string['tutor_usage_report_rolescope_all'] = 'Tutti';
$string['tutor_usage_report_rolescope_students'] = 'Studenti';
$string['tutor_usage_report_rolescope_teachers'] = 'Docenti';
$string['tutor_usage_report_stacked_bar'] = 'Messaggi per modalità nel tempo';
$string['tutor_usage_report_summary'] = 'Riepilogo';
$string['tutor_usage_report_table_courses'] = 'Corsi';
$string['tutor_usage_report_table_modules'] = 'Attività';
$string['tutor_usage_report_table_users'] = 'Utenti';
$string['tutor_usage_report_view_custom'] = 'Intervallo personalizzato';
$string['tutor_usage_report_view_month'] = 'Mese';
$string['tutor_usage_report_view_week'] = 'Settimana';
$string['view_credit_report'] = 'Visualizza report utilizzo crediti';
$string['viewtutorusage'] = 'Visualizza report utilizzo tutor nei corsi';
$string['viewtutorusage_desc'] = 'Consente di visualizzare analisi sull\'utilizzo del tutor e dettagli per utente nei corsi in cui è assegnata questa capability. Report ed export includono nomi utente.';
$string['viewtutorusagesite'] = 'Visualizza report utilizzo tutor a livello di sito';
$string['viewtutorusagesite_desc'] = 'Consente analisi sull\'utilizzo del tutor su tutti i corsi, inclusi export con nomi di utenti e corsi. Assegnare solo a ruoli fidati.';
$string['viewusage_desc'] = 'Consente l\'accesso alla panoramica, al report dettagliato e alle esportazioni dell\'utilizzo crediti su tutto il sito. Il report include nomi di utenti e corsi. Assegnare solo a ruoli fidati; i manager la ricevono per impostazione predefinita. Gli utenti con local/dixeo:manage possono aprire il report.';
