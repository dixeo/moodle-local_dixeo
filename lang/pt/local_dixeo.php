...
$string['content_image_failed'] = 'Ocorreu um erro';
$string['content_image_generating'] = 'A gerar...';
$string['contentimagetitlefallback'] = 'Imagem de conteúdo';
$string['credit_action_assign_authorship'] = 'Verificação de autoria da tarefa';
$string['credit_action_assign_grade'] = 'Avaliação de tarefa com IA';
$string['credit_action_assign_review'] = 'Revisão de tarefa';
...
$string['credit_moduletype_assign'] = 'Trabalho';
...
$string['tutor_usage_report_cell_tooltip_sessions'] = 'Duração média: {$a->average} · Total: {$a->total}';
...
$string['tutor_usage_report_heatmap_info'] = 'Número total de mensagens enviadas em cada intervalo de três horas, por dia da semana.';
$string['tutor_usage_report_kpi_adoption'] = 'Adoção';
$string['tutor_usage_report_kpi_adoption_info'] = 'Proporção de utilizadores do âmbito que usaram o tutor pelo menos uma vez durante o período.';
...
$string['tutor_usage_report_kpi_duration_info'] = 'Tempo total gasto a interagir com o tutor durante o período.';
...
$string['tutor_usage_report_kpi_engagement_info'] = 'O total do número de dias em que os utilizadores interagiram com o tutor durante o período';
$string['tutor_usage_report_kpi_engagement_info_user'] = 'Número de dias distintos em que este utilizador usou o tutor durante o período.';
$string['tutor_usage_report_kpi_engagement_secondary'] = 'Última atividade: {$a}';
$string['tutor_usage_report_kpi_engagement_secondary_aggregate'] = 'Mediana {$a->median} / Média {$a->average} dias ativos por utilizador ativo';
$string['tutor_usage_report_kpi_engagement_value'] = '{$a} dias';
$string['tutor_usage_report_kpi_messages'] = 'Mensagens';
$string['tutor_usage_report_kpi_messages_info'] = 'Número total de mensagens enviadas ao tutor durante o período.';
$string['tutor_usage_report_kpi_messages_secondary'] = 'Mediana {$a->median} / Média {$a->average}';
$string['tutor_usage_report_kpi_mode_desc_lesson'] = 'lições criadas';
$string['tutor_usage_report_kpi_mode_desc_messages'] = 'mensagens enviadas';
$string['tutor_usage_report_kpi_mode_desc_quiz'] = 'questionários enviados';
$string['tutor_usage_report_kpi_mode_info_guide'] = 'Mensagens enviadas no modo Guia, em que o tutor conduz o aluno à resposta em vez de a dar.';
$string['tutor_usage_report_kpi_mode_info_normal'] = 'Mensagens enviadas no modo Padrão, em que o tutor responde diretamente às perguntas.';
$string['tutor_usage_report_kpi_mode_info_quiz'] = 'Mensagens enviadas no modo Teste, os resultados do teste são enviados ao tutor para análise.';
$string['tutor_usage_report_kpi_mode_info_teach'] = 'Mensagens enviadas no modo Ensinar, as lições geradas passam a fazer parte da conversa.';
$string['tutor_usage_report_kpi_mode_secondary_quiz'] = 'Questionários criados: {$a}';
$string['tutor_usage_report_kpi_sessions'] = 'Sessões';
$string['tutor_usage_report_kpi_sessions_info'] = 'Número de sessões com o tutor. Uma sessão começa na primeira mensagem e fecha após {$a} sem uma nova.';
$string['tutor_usage_report_kpi_sessions_secondary'] = 'Mediana {$a->median} / Média {$a->average}';
$string['tutor_usage_report_level_site'] = 'Todos os cursos';
...
$string['tutor_usage_report_rolescope_all'] = 'Todos';
$string['tutor_usage_report_rolescope_students'] = 'Estudantes';
$string['tutor_usage_report_rolescope_teachers'] = 'Professores';
