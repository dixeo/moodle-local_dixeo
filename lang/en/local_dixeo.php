...
$string['content_image_failed'] = 'An error occurred';
$string['content_image_generating'] = 'Generating...';
...
$string['tutor_usage_report_kpi_duration'] = 'Duration';
$string['tutor_usage_report_kpi_duration_info'] = 'Total time spent interacting with the tutor during the period.';
...
$string['tutor_usage_report_kpi_engagement_info'] = 'The total of the number of days that users interacted with the tutor during the period';
...
$string['tutor_usage_report_kpi_messages_info'] = 'Total number of messages sent to the tutor during the period.';
