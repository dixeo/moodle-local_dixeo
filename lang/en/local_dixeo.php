...
$string['tutor_usage_report_apply_filters'] = 'Apply filters';
...
$string['tutor_usage_report_cell_tooltip_sessions'] = 'Average duration: {$a}';
...
$string['tutor_usage_report_filters'] = 'Filters';
...
$string['tutor_usage_report_kpi_mode_secondary_lesson'] = 'Lessons created: {$a}';
...
$string['tutor_usage_report_reset_filters'] = 'Reset';
$string['tutor_usage_report_rolescope_all'] = 'All users';
$string['tutor_usage_report_rolescope_students'] = 'Students only';
$string['tutor_usage_report_rolescope_teachers'] = 'Teachers only';
