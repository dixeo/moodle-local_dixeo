...
$string['assign_submission_no_readable_files'] = 'No analyzable files were found. Supported formats: PDF, plain text (.txt). Please submit files in one of these formats.';
$string['assign_submission_some_files_not_readable'] = 'The following file(s) could not be analyzed (unsupported format or read error): {$a}.';
$string['assign_submission_unsupported'] = 'Only online text and file submissions are supported for analysis. This assignment does not have either enabled.';
$string['assign_ux_authorship_final_incomplete'] = 'Final authorship evaluation requires initial confidence, questions, and answers.';
$string['assign_ux_authorship_mode_invalid'] = 'Invalid authorship mode. Use confidence, quiz, or final.';
$string['assign_ux_grading_criteria_count'] = 'Grading response criteria count does not match assignment (got {$a->got}, expected {$a->expected}).';
$string['assign_ux_grading_invalid_criterion'] = 'Grading response contains invalid criterion id: {$a}.';
$string['assign_ux_grading_invalid_level'] = 'Grading response contains invalid level id {$a->levelid} for criterion {$a->criterionid}.';
$string['assign_ux_result_missing'] = 'The AI response was missing or incomplete.';
$string['assign_ux_submission_invalid'] = '{$a}';
...
$string['credit_action_assign_authorship'] = 'Assignment authorship check';
$string['credit_action_assign_grade'] = 'Assignment AI grading';
$string['credit_action_assign_review'] = 'Assignment review';
